...
`)===-1?$(`
 - `,`
`):_.startsWith(" - ")?$("","","",{filterValue:(E,q)=>{if(be>=0){let O=ue.replace(/^ - /,"");de=R+O,q.pos-=ue.length-O.length}return de+W},filterSelection:E=>E.replace(/^ - /g,"").replace(/\n - /g,`
`)}):$("",""," - ",{selectionAtEnd:!0,filterSelection:E=>" - "+E.replace(/\n$/,"").replace(/\n/g,`
 - `)+`
`})}else $(`
 - `,`
