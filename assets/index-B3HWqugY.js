...
`)===-1?F(`
 - `,`
`):_.startsWith(" - ")?F("","","",{filterValue:(E,q)=>{if(be>=0){let O=ue.replace(/^ - /,"");de=R+O,q.pos-=ue.length-O.length}return de+W},filterSelection:E=>E.replace(/^ - /g,"").replace(/\n - /g,`
`)}):F("",""," - ",{selectionAtEnd:!0,filterSelection:E=>" - "+E.replace(/\n$/,"").replace(/\n/g,`
 - `)+`
`})}else F(`
 - `,`
