  ...
  <div class="mx-auto mt-16 max-w-7xl px-4 sm:mt-24">
    <div class="text-center">
      <h1 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl md:text-6xl">
        ...
        <span class="block text-green-600 dark:text-green-500 xl:inline">Press Vue</span>
      </h1>
  ...
  <div class="relative">
    <div class="mt-8 max-w-6xl mx-auto">
      <div class="aspect-w-16 aspect-h-9">
        <LiteYouTube id="u3FcgWlack4" title="Vite Vue Markdown Websites with Vite Press Plugin, Host for Free on GitHub Pages" />
      </div>
    </div>
  </div>
